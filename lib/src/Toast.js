...
const ToastRoot = React.forwardRef((props, ref) => {
    ...
    return (<ToastUI isVisible={isVisible} options={options} data={data} hide={hide} show={show} unmount={unmount} config={config}/>);
});
let refs = [];
/**
...
export function Toast(props) {
    ...
    */
    ...
    return (<LoggerProvider enableLogs={!!enableLogs}>
